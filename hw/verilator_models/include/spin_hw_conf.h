...
#define L2_BASE_ADDR 0x1c000000
...
#define L1_CLUSTER_SIZE 0x00400000
...
#define L1_BASE_ADDR 0x10000000
#define L1_SCRATCHPAD_ADDR(CLUSTER_ID) (L1_BASE_ADDR) + (CLUSTER_ID)*(L1_CLUSTER_SIZE) + (L1_SCRATCHPAD_OFFSET)